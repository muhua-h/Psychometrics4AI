#!/usr/bin/env python3
"""
Unified Participant Recovery Script for Study 2a
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Recover missing participants from Study 2a simulation results")
    ...
    print("="*80)
    print("UNIFIED PARTICIPANT RECOVERY FOR STUDY 2a")
    print("="*80)
