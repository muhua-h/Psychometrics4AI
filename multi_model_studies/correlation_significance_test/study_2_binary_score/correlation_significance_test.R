...
correlations <- data.frame(
  ...
  O = c(0.6961, 0.7886, 0.8098, 0.8186, 0.7605,
        0.7062, 0.7722, 0.8179, 0.7885, 0.7504,
        0.7843, 0.7936, 0.8205, 0.8486, 0.8091,
        0.5667, 0.6773, 0.8576, 0.8866, 0.8165),
  C = c(0.7905, 0.9351, 0.9133, 0.9242, 0.9204,
        0.7742, 0.9303, 0.9172, 0.9216, 0.9202,
        0.7936, 0.8738, 0.9314, 0.9154, 0.9207,
        0.8484, 0.9096, 0.9257, 0.9149, 0.9200),
  E = c(0.8771, 0.8855, 0.8805, 0.8842, 0.8849,
        0.8736, 0.8882, 0.8806, 0.8862, 0.8790,
        0.8608, 0.9046, 0.9169, 0.9206, 0.9071,
        0.8607, 0.9249, 0.9218, 0.9376, 0.9315),
  A = c(0.7417, 0.9121, 0.8805, 0.8805, 0.8926,
        0.7264, 0.9205, 0.8810, 0.8646, 0.8788,
        0.6050, 0.8306, 0.9112, 0.8954, 0.8881,
        0.7156, 0.9065, 0.9117, 0.8780, 0.9073),
  N = c(0.5659, 0.8800, 0.8965, 0.8666, 0.8792,
        0.5834, 0.8811, 0.8956, 0.8651, 0.8814,
...
output_file <- file.path(script_dir, "correlation_significance_results_updated.csv")
...
tryCatch({
  ...
  fallback_file <- "correlation_significance_results_updated.csv"
