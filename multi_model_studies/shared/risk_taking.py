...
investment = ("Scenario: Investment\n"
              ...
              "the government bond, how would act in this situation?You have "
              "recently come into a modest sum of money and are contemplating "
              "how to invest it. You're torn between a high-risk, high-reward "
              "stock that has the potential to either significantly increase "
              "your wealth or decrease in value, and a low-risk government "
              "bond that offers guaranteed but modest returns. On a scale of "
              "1 to 10, where 1 means fully embracing the potential high "
              "rewards of the risky stock, and 10 means preferring the safety "
              "and guaranteed return of the government bond, how would act in "
              "this situation?")
...
extreme_sports = ("Scenario: Extreme_Sports \n"
                  ...
                  "act in this situation?You've always been fascinated by "
                  "extreme sports and are considering taking up base jumping, "
                  "drawn by the thrill and the challenge it presents. "
                  "However, you're fully aware of the significant physical "
                  "risks involved, including the potential for severe injury. "
                  "On a scale of 1 to 10, where 1 means diving into the sport "
                  "for the ultimate thrill despite the risks, and 10 means "
                  "prioritizing your physical safety and choosing not to "
                  "participate, how would act in this situation?")
