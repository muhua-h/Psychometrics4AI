#!/usr/bin/env python3
"""
Study 2b Multi-Model Risk-Taking Behavioral Validation Analysis
...
def run_regression_analysis(data, target_prefix='risk_1'):
...
def main():
    ...
    print("="*80)
    print("Study 2b Multi-Model Risk-Taking Behavioral Validation Analysis")
    print("="*80)
    ...
    if all_results:
        ...
        sum_results = combined_results[combined_results['target'] == 'risk_sum']
