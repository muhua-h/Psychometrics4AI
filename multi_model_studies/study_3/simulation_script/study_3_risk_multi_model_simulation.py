#!/usr/bin/env python3
"""
Study 2b Multi-Model Risk-Taking Scenario Simulation
...
def process_participant_risk_with_retry(participant_data, model, temperature=0.0):
...
def process_participant_risk(participant_data, model, temperature=0.0):
    ...
    try:
        return process_participant_risk_with_retry(participant_data, model, temperature)
    except Exception as e:
...
def main():
    ...
    print("="*80)
    print("Study 2b Multi-Model Risk-Taking Scenario Simulation")
    print("="*80)
    ...
    print(f"\nPreprocessed data saved to {output_path / 'study4_risk_preprocessed_data.csv'}")
