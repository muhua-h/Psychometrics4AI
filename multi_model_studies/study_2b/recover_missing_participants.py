#!/usr/bin/env python3
"""
Unified Participant Recovery Script for Study 2b
...
def prepare_participant_data_for_format(participant_data: Dict[str, Any],
    ...
    For Study 2b, this involves creating the appropriate format descriptions.
    """
    if format_type == 'binary':
...
def create_expanded_description(data_row: pd.Series) -> str:
    ...
    This replicates the logic from Study 2b expanded notebook.
    """
    ...
    # Apply reverse coding (same as in Study 2b notebook)
    reverse_coding_map = {
...
def create_likert_description(data_row: pd.Series) -> str:
    ...
    This replicates the logic from Study 2b likert notebook.
    """
...
def recover_participants_for_model(model_info: Dict[str, Any],
    ...
    for idx in info['problematic_indices']:
        if idx < len(data):
            ...
            # Convert Study 2b data format to the format expected by prompts
            participant_data = {
...
def main():
    ...
    # Define format configurations for Study 2b
    format_configs = [
        {
    ...
    print("=" * 80)
    print("UNIFIED PARTICIPANT RECOVERY FOR STUDY 2b")
    print("=" * 80)
    print(
