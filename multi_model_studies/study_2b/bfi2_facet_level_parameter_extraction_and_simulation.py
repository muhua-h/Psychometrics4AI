...
This script replicates the original Study 2b facet-level data generation approach,
...
Based on: study_2b/likert_format/bfi2-facet-level-parameter-extraction-and-simulation.ipynb
"""
...
def load_original_data():
    """Load the original Study 2b data with proper path handling"""
    # Try multiple possible paths for the original data
    possible_paths = [
        '../../study_2b/likert_format/data.csv',
        '../../../study_2b/likert_format/data.csv',
        'data.csv'
    ]
    ...
    raise FileNotFoundError(f"Could not find original Study 2b data. Tried paths: {possible_paths}")
