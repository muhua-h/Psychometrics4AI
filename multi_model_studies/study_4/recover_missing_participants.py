#!/usr/bin/env python3
"""
Study 4 Participant Recovery Script

This script detects missing participants in Study 4 moral and risk scenario simulations
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Recover missing participants from Study 4 simulation results")
    ...
    # Define scenario configurations for Study 4
    scenario_configs = [
        {
    ...
    print("=" * 80)
    print("STUDY 4 PARTICIPANT RECOVERY")
    print("=" * 80)
