...
def process_participant_moral(participant_data, model, temperature=0.0):
    """Process a single participant for moral reasoning scenarios"""
    try:
...
def main():
    ...
    for model in models_to_test:
        try:
            results = run_moral_simulation(participants_data, model, temperature, output_dir)
    ...
    # Results summary
    print("\n" + "="*50)
    print("Moral Simulation Results Summary:")
    print("="*50)
    ...
    print(f"Preprocessed data saved to {output_path / 'study4_moral_preprocessed_data.csv'}")
