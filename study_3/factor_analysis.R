...
# Read the CSV file
data <- read_csv("~/psychometrics_AI/study_2/likert_format/mini_marker_response.csv")
...
# Read the CSV file
data <- read_csv("~/psychometrics_AI/study_2/expanded_format/mini_marker_response.csv")
